...
type PanOptions = ( duration::Int, easing::Easing.EasingFunction )
...
type PanIntoViewOptions po = { animation::Record po, margin::Int }
...
type Options po = (element::Element
                , autoPan::AutoPan
...
create  :: forall l r lpo rpo . Union l r (Options lpo)
